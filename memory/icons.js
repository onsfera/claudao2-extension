/*
 * Claudão² - ícones Lucide (inline, sem CDN por causa da CSP).
 * Paths oficiais do lucide.dev (ISC License). Uso: LucideIcons.get("brain", 18).
 */
(function () {
  "use strict";
  ...
  const P = {
    ...
    upload:
      '<path d="M12 3v12"/><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="m17 8-5-5-5 5"/>',
    "rotate-ccw":
    ...
    history:
      '<path d="M3 12a9 9 0 1 0 3-7.7L3 8"/><path d="M3 3v5h5"/><path d="M12 7v5l4 2"/>',
    "messages-square":
